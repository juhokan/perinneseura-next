...
export default function Home() {
  return (
    <>
      <div
        className="bg absolute -z-10 w-screen h-screen flex items-center bg-cover bg-center 
      ...
      >
        <section>
          <div>
            <h1 className="text-6xl text-slate-100 z-30 px-4 py-2 lg:text-8xl lg:px-8 lg:py-2">
              PerinneSeura
            </h1>
